...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String story = "Piranha's are more " + adjective + " during the day, so cross the river at night. Piranha's are attracted \n"
		+ " to fresh " + liquid + " and will most likely take a bite out of your " + bodyPart + " if you " + verb + "." + "Whatever \n"
